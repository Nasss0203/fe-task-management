						...
						<div className='space-y-6'>
							<div className='space-y-5'>
								<TaskStatusField
									...
									onOpenChange={detail.status.onOpenChange}
									statuses={detail.status.options}
									selectedStatusId={detail.status.selectedId}
								...
								<TaskPriorityField
									...
									onOpenChange={detail.priority.onOpenChange}
								...
								<TaskScheduleField
									...
									onOpenChange={detail.schedule.onOpenChange}
									onSelect={detail.schedule.onSelect}
								/>

								<TaskAssigneeField
									open={detail.assignee.open}
									onOpenChange={detail.assignee.onOpenChange}
									isUpdatingTask={
									...
									onToggleAssignee={detail.assignee.onToggle}
									onUnassignAssignee={
								...
								<TaskTagsField
									...
									priorityName={detail.display.priorityName}
								/>
