...
import { useLandingTemplates } from "../model/use-templates";
import type { TemplateItem } from "../model/template-data";
import TemplateCard from "./template-card";

export default function TemplatesSection() {
	const { landingTemplatesQuery } = useLandingTemplates({
		visibility: "PUBLIC",
		status: "PUBLISHED",
	});

	const { data, isLoading } = landingTemplatesQuery;
