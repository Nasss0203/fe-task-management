...
export default function TemplatePreview({ variant }: TemplatePreviewProps) {
	if (variant === "mindmap") {
		return (
			<div className='relative h-full w-full rounded-xl border border-border bg-card p-4'>
				<div className='absolute left-1/2 top-1/2 h-3 w-16 -translate-x-1/2 -translate-y-1/2 rounded-full bg-primary' />
	...
	if (variant === "checklist") {
		return (
			<div className='h-full w-full rounded-xl border border-border bg-card p-4'>
				<div className='mb-4 flex items-center justify-between'>
					<div className='h-3 w-20 rounded bg-border' />
					<div className='h-3 w-10 rounded bg-primary/80' />
				</div>

				<div className='space-y-3'>
					<div className='flex items-center gap-3'>
						<div className='h-4 w-4 rounded border border-primary/20 bg-secondary' />
			...
			<div className='h-full w-full rounded-xl border border-border bg-card p-4'>
				...
				<div className='space-y-3'>
					<CardBox className='p-3'>
						...
						<Pill className='mb-2 w-full bg-primary' />
						<Pill className='w-2/3 bg-red-500' />
					</CardBox>

					<CardBox className='p-3'>
						<div className='mb-2 h-3 w-16 rounded bg-border' />
				...
				<div className='grid h-[calc(100%-28px)] grid-cols-2 gap-3'>
					<CardBox className='p-3'>
						...
						<div className='space-y-2'>
							<Pill className='w-full bg-border' />
							<Pill className='w-4/5 bg-border' />
							<Pill className='w-2/3 bg-border' />
						</div>
					</CardBox>

					<div className='space-y-3'>
						<CardBox className='p-3'>
							<div className='mb-2 h-3 w-14 rounded bg-border' />
	...
	return (
		<div className='h-full w-full rounded-xl border border-border bg-card p-4'>
			...
			<div className='grid h-[calc(100%-28px)] grid-cols-3 gap-3'>
				<CardBox className='p-3'>
					<div className='mb-3 h-3 w-14 rounded bg-border' />
					<div className='space-y-2'>
						<Pill className='w-full bg-primary' />
						<Pill className='w-5/6 bg-red-500' />
						<Pill className='w-2/3 bg-emerald-500' />
					</div>
				</CardBox>
				...
				<CardBox className='p-3'>
					<div className='mb-3 h-3 w-12 rounded bg-border' />
					<div className='space-y-2'>
				...
				<CardBox className='p-3'>
					...
					<div className='space-y-2'>
						...
						<Pill className='w-5/6 bg-primary' />
						<Pill className='w-2/3 bg-emerald-500' />
					</div>
				</CardBox>
			</div>
